...
exports.validateTokenController = exports.SECRET_KEY = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
exports.SECRET_KEY = "7896-5630-7564-0809";
const validateTokenController = (token) => {
    return new Promise((resolve, reject) => {
        try {
            ...
            reject("Please login again with proper Email" /* errorMsg.incorrectUserId */);
        }
    });
};
